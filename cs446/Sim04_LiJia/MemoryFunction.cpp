 ...
 */
unsigned int allocateMemory( int prevAddress, int blockSize, int memorySize )
{
	unsigned int address = (prevAddress + blockSize) % memorySize;

	return address;
}

#endif // MEM_FUNC_CPPand(time(NULL));
